...
public class DubboOrderController {
    ...
    public ResEntity<String> payOrder(@Param("orderId") String orderId) throws MQClientException, UnsupportedEncodingException {
        // 已有订单付款
    ...
    public ResEntity<String> cancelOrder(@Param("orderId") String orderId){
        // 已有订单付款
