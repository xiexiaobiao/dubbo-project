...
import com.biao.mall.stock.util.SentinelRuleUtil;
...
public class DubboStockServiceImpl extends ServiceImpl<DubboStockDao, DubboStockEntity> implements DubboStockService {
    ...
    static {
        /*使用Nacos中配置流规则，注意定义resourceName，这里的
        loadFlowRules中的NacosDataSource，值得研究一下，里面包含了线程池和监听器，能自动刷新Nacos的规则*/
    ...
    */
    ...
    private void initWhiteRules(String resourceName){
        ...
        rule.setLimitApp("appA,mall-business");
