...
public class MsgConsumerService {
    ...
    private final Logger logger = LoggerFactory.getLogger(MsgConsumerService.class);

    @RabbitListener(queues = RabbitConf.QUEUE_C,containerFactory = "customContainerFactory")//指定监听的队列
